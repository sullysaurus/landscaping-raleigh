...
export const seoTargets: SeoTarget[] = [
  ...
  { keyword: 'patio drainage', volume: 1000, intent: 'Solve', audience: 'Homeowners planning or troubleshooting a patio', content: 'Patio drainage in Raleigh clay soil', type: 'Technical guide', status: 'Planned', nextStep: 'Draft next; keep distinct from retaining-wall drainage' },
  { keyword: 'landscape lighting ideas', volume: 2400, intent: 'Learn', audience: 'Homeowners planning evening use and curb appeal', content: 'Landscape lighting ideas for Raleigh gardens', type: 'Visual guide', status: 'Planned', nextStep: 'Collect strong dusk and nighttime photography first' },
  { keyword: 'rain garden plants nc', volume: 50, intent: 'Learn', audience: 'Homeowners planning a rain garden', content: 'Rain-garden plants for NC sun, shade and clay', type: 'Plant guide', status: 'Planned', nextStep: 'Next high-fit horticultural guide' },
  { keyword: 'raleigh rainwater rewards', volume: 40, intent: 'Compare', audience: 'Raleigh property owners considering stormwater funding', content: 'Raleigh Rainwater Rewards homeowner guide', type: 'Local program guide', status: 'Planned', nextStep: 'Confirm current City program rules before publishing' },
  { keyword: 'best time to plant trees in north carolina', volume: 50, intent: 'Learn', audience: 'NC homeowners timing a tree or shrub project', content: 'When to plant trees and shrubs in North Carolina', type: 'Seasonal guide', status: 'Planned', nextStep: 'Publish after the drainage cluster' },
  { keyword: 'landscape lighting cost', volume: 140, intent: 'Compare', audience: 'Homeowners budgeting for outdoor lighting', content: 'Landscape lighting cost and design choices', type: 'Cost guide', status: 'Planned', nextStep: 'Pair with lighting ideas once service scope is confirmed' },
